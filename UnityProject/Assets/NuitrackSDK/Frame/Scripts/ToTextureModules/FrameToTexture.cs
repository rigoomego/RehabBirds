...
namespace NuitrackSDK.Frame
{
        ...
        where U : struct
    {
        ...
        protected RenderTexture InitRenderTexture(int width, int height, RenderTextureFormat renderTextureFormat = RenderTextureFormat.ARGB32)
        {
        ...
        {
            return GPUSupported ? 
                GetRenderTexture(SourceFrame, textureCache) : 
                GetTexture2D(SourceFrame, textureCache);
        }
