	...
	SubShader 
	{
	    ...
	    Pass
	    {
            ...
            v2f vert (appdata v)
            {
				...
				//real positions of pixel in Unity Units (mm from depth data -> normalized for depth texture -> denormalized\converting to Unity Units):
				float z = depthCol * _scale;
				...
				float zRight = 	zRightCol.r * _scale;
				float zUp = 	zUpCol.r * _scale;
				float zRightUp = zRightUpCol.r * _scale;
            ...
            fixed4 frag(v2f i) : SV_Target
            {
				...
				//in this case, it removes the stretched edges of the mesh
